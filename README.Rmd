...
Class material and functions for S&DS 111: Introduction to Data Display and Analysis


## Installing the SDS111 package

To install the SDS111 package that contains functions that are useful for the
...
Once you have installed the SDS111 package, you can use this package to install other packaged required by the class as well as LaTeX using the `SDS111:::initial_setup()` function shown below. 
